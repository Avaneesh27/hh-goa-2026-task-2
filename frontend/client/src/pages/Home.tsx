...
const languages: Language[] = [
  ...
  { code: "GU",   name: "Gujarati",     native: "ગુજરાતી",            sample: "કોર્પોરેશન એટલે શું?" },
  { code: "KN",   name: "Kannada",      native: "ಕನ್ನಡ",              sample: "ಕಾರ್ಪೊರೇಷನ್ ಎಂದರೇನು?" },
  { code: "ML",   name: "Malayalam",    native: "മലയാളം",             sample: "കോർപ്പറേഷൻ എന്നാൽ എന്ത്?" },
  { code: "PA",   name: "Punjabi",      native: "ਪੰਜਾਬੀ",             sample: "ਕਾਰਪੋਰੇਸ਼ਨ ਕੀ ਹੈ?" },
  { code: "OR",   name: "Odia",         native: "ଓଡ଼ିଆ",              sample: "କର୍ପୋରେସନ ଅର୍ଥ କ'ଣ?" },
  { code: "AS",   name: "Assamese",     native: "অসমীয়া",            sample: "কৰ্পোৰেচন মানে কি?" },
  { code: "UR",   name: "Urdu",         native: "اردو",               sample: "کارپوریشن کیا ہے؟" },
  { code: "EN",   name: "English",      native: "English",             sample: "What is a corporation?" },
];
