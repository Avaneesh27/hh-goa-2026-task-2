"""
Guardrails and Deterministic Abstention Pipeline for Multilingual RAG.
Implements:
  ...
  4. Explicit Multilingual Abstention Handler
"""
...
from backend.keywords import UNSAFE_PATTERNS
...
class GuardrailManager:
    def __init__(
        ...
        min_grounding_ratio: float = 0.35
    ):
        self.min_retrieval_score = min_retrieval_score
        self.min_grounding_ratio = min_grounding_ratio
        self.word_token_pattern = re.compile(r"[\w\u0900-\u097F]+", re.UNICODE)
    ...
    def check_rerank_confidence(
        ...
        bm25_rank = top_item.get("bm25_rank", None)
    ...
    def check_grounding(
        ...
        Computes lexical overlap of content tokens and checks for explicit abstention signals.
        ...
        # Filter out short single-letter or punctuation tokens
    ...
    def get_abstention_response(
        ...
        """
        if language == "hi":
            msg = "मुझे इस प्रश्न का विश्वसनीय उत्तर देने के लिए उपलब्ध डेटासेट में पर्याप्त प्रासंगिक जानकारी नहीं मिली।"
        elif language == "hinglish":
            msg = "Mujhe retrieved dataset mein is sawaal ka answer karne ke liye sufficient evidence nahi mila."
        else:
            msg = "I couldn't find sufficient evidence in the retrieved dataset to answer that reliably."
